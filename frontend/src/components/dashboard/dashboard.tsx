    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-6">
        <div className="rs-card p-6 text-center animate-stagger-1">
          ...
          <div className="text-sm text-slate-600 dark:text-slate-300 mt-1">Total Videos</div>
        </div>
        ...
        <div className="rs-card p-6 text-center animate-stagger-2">
          ...
          <div className="text-sm text-slate-600 dark:text-slate-300 mt-1">Analyzed Frames</div>
        </div>
        ...
        <div className="rs-card p-6 text-center animate-stagger-3">
          ...
          <div className="text-sm text-slate-600 dark:text-slate-300 mt-1">Searches Performed</div>
        </div>
        ...
        <div className="rs-card p-6 text-center animate-stagger-4">
          ...
          <div className="text-sm text-slate-600 dark:text-slate-300 mt-1">Processing Jobs</div>
        </div>
        ...
        <div className="rs-card p-6 text-center animate-stagger-5">
          ...
          <div className="text-sm text-slate-600 dark:text-slate-300 mt-1">Avg Processing</div>
        </div>
        ...
        <div className="rs-card p-6 text-center animate-stagger-6">
          ...
          <div className="text-sm text-slate-600 dark:text-slate-300 mt-1">Storage Used</div>
        </div>
      </div>
      ...
      <div className="space-y-6">
        <div className="text-center">
          ...
          <p className="text-slate-600 dark:text-slate-300 mt-2">Get started with common tasks</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
          {quickActions.map((action) => (
            ...
            >
              ...
              <p className="text-slate-600 dark:text-slate-300 text-sm leading-relaxed">{action.description}</p>
      ...
      <div className="rs-card p-8">
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-slate-600 dark:text-slate-300 mt-1">Latest platform activity and processing updates</p>
          </div>
          <button 
        ...
        <div className="space-y-4">
          {recentActivity.map((activity) => (
            <div key={activity.id} className="flex items-center space-x-4 p-4 rounded-xl hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors duration-200">
              <div className={clsx(
            ...
            <div className="p-6 border-b border-gray-200 dark:border-slate-700">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-gray-600 dark:text-slate-300 mt-1">Comprehensive history of all platform activities</p>
                </div>
                <button
                  onClick={() => setShowActivityModal(false)}
                  className="text-gray-400 dark:text-slate-500 hover:text-gray-600 dark:hover:text-slate-300 p-2 hover:bg-gray-100 dark:hover:bg-slate-700 rounded-lg transition-colors"
                >
            ...
            <div className="overflow-y-auto max-h-[70vh] p-6">
              <div className="space-y-4">
                {fullActivityLog.map((activity) => (
                  <div key={activity.id} className="flex items-start space-x-4 p-4 rounded-xl hover:bg-gray-50 dark:hover:bg-slate-700 transition-colors border border-gray-100 dark:border-slate-600">
                    <div className={clsx(
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between">
                        <p className="text-sm font-semibold text-gray-900 dark:text-white">{activity.description}</p>
                        <div className={clsx(
                          'px-3 py-1 rounded-full text-xs font-semibold flex-shrink-0',
                          activity.status === 'processing' ? 'bg-amber-100 text-amber-700 dark:bg-amber-900 dark:text-amber-300' :
                          activity.status === 'completed' ? 'bg-emerald-100 text-emerald-700 dark:bg-emerald-900 dark:text-emerald-300' : 'bg-gray-100 text-gray-700 dark:bg-slate-700 dark:text-slate-300'
                        )}>
                          {activity.status === 'processing' && (
                            <div className="flex items-center space-x-1">
                              <div className="w-2 h-2 bg-amber-500 rounded-full animate-pulse"></div>
                      ...
                      <div className="flex items-center justify-between mt-2">
                        ...
                        {(activity as any).details && (
                          <p className="text-xs text-gray-600 dark:text-slate-300">{(activity as any).details}</p>
                        )}
                      </div>
                    </div>
                  </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex space-x-3">
                  <button
                    ...
                    className="px-4 py-2 text-gray-700 dark:text-slate-300 font-medium rounded-lg hover:bg-gray-200 dark:hover:bg-slate-600 transition-colors"
                  >
                    Export Log
                  </button>
                  <button
