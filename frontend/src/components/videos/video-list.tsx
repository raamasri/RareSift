...
export function VideoList() {
  ...
  // Function to get thumbnail path for a video
  const getThumbnailPath = (video: any): string => {
    // Map video IDs to available demo frames
    const videoFrameMap: { [key: string]: string } = {
      'gh010001': '/demo-assets/frames/drive_01_frame_001.jpg',
      'gh010002': '/demo-assets/frames/drive_02_frame_001.jpg', 
      'gh010003': '/demo-assets/frames/drive_03_frame_001.jpg',
      'gh010004': '/demo-assets/frames/drive_01_frame_003.jpg', // Reuse available frames
      'gh010005': '/demo-assets/frames/drive_02_frame_003.jpg',
      'gh010006': '/demo-assets/frames/drive_03_frame_003.jpg',
      'gh010007': '/demo-assets/frames/drive_01_frame_005.jpg',
      'gh010010': '/demo-assets/frames/drive_02_frame_005.jpg',
      'gh020010': '/demo-assets/frames/drive_03_frame_005.jpg',
      'gh010031': '/demo-assets/frames/static_03_frame_000.jpg',
      'gh010032': '/demo-assets/frames/static_04_frame_000.jpg',
      'gh010033': '/demo-assets/frames/static_04_frame_001.jpg',
      'gh010034': '/demo-assets/frames/static_03_frame_000.jpg', // Reuse for missing ones
      'gh010035': '/demo-assets/frames/static_04_frame_000.jpg',
      'gh010036': '/demo-assets/frames/static_04_frame_001.jpg',
      'gh010037': '/demo-assets/frames/static_03_frame_000.jpg',
      'gh010038': '/demo-assets/frames/static_04_frame_000.jpg',
      'gh010039': '/demo-assets/frames/static_04_frame_001.jpg',
      'gh010041': '/demo-assets/frames/static_03_frame_000.jpg',
      'gh010042': '/demo-assets/frames/static_04_frame_000.jpg',
      'gh010043': '/demo-assets/frames/static_04_frame_001.jpg',
      'gh010045': '/demo-assets/frames/static_03_frame_000.jpg'
    }
    
    // Extract video ID from filename (e.g., "GH010001.MP4" -> "gh010001")
    const filename = video.filename.toLowerCase()
    const videoId = filename.replace('.mp4', '')
    
    // Return mapped frame or fallback to first driving frame
    return videoFrameMap[videoId] || '/demo-assets/frames/drive_01_frame_001.jpg'
  }

  // Function to get video path for a video
  const getVideoPath = (video: any): string => {
    // Map video IDs to available video files
    const videoPathMap: { [key: string]: string } = {
      'gh010001': '/videos/driving_camera_footage/GH010001.MP4',
      'gh010002': '/videos/driving_camera_footage/GH010002.MP4',
      'gh010003': '/videos/driving_camera_footage/GH010003.MP4',
      'gh010004': '/videos/driving_camera_footage/GH010004.MP4',
      'gh010005': '/videos/driving_camera_footage/GH010005.MP4',
      'gh010006': '/videos/driving_camera_footage/GH010006.MP4',
      'gh010007': '/videos/driving_camera_footage/GH010007.MP4',
      'gh010010': '/videos/driving_camera_footage/GH010010.MP4',
      'gh020010': '/videos/driving_camera_footage/GH020010.MP4',
      'gh010031': '/videos/static_camera_footage/GH010031.MP4',
      'gh010032': '/videos/static_camera_footage/GH010032.MP4',
      'gh010033': '/videos/static_camera_footage/GH010033.MP4',
      'gh010034': '/videos/static_camera_footage/GH010034.MP4',
      'gh010035': '/videos/static_camera_footage/GH010035.MP4',
      'gh010036': '/videos/static_camera_footage/GH010036.MP4',
      'gh010037': '/videos/static_camera_footage/GH010037.MP4',
      'gh010038': '/videos/static_camera_footage/GH010038.MP4',
      'gh010039': '/videos/static_camera_footage/GH010039.MP4',
      'gh010041': '/videos/static_camera_footage/GH010041.MP4',
      'gh010042': '/videos/static_camera_footage/GH010042.MP4',
      'gh010043': '/videos/static_camera_footage/GH010043.MP4',
      'gh010045': '/videos/static_camera_footage/GH010045.MP4'
    }
    ...
    // Return mapped video path or fallback
    return videoPathMap[videoId] || '/videos/driving_camera_footage/GH010001.MP4'
  }
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-slate-800 rounded-lg shadow-sm border border-gray-200 dark:border-slate-700 p-6">
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-lg font-semibold text-gray-900 dark:text-white">Video Library</h2>
          ...
          <div className="flex items-center space-x-4">
            <div className="flex items-center space-x-2">
              ...
              />
              <label htmlFor="processed-only" className="text-sm text-gray-700 dark:text-slate-300">
                Show processed only
              </label>
            </div>
        ...
        <div className="space-y-4">
          {videos.map((video: any) => {
            ...
            return (
              <div
                key={video.id}
                className="bg-white dark:bg-slate-800 rounded-lg shadow-sm border border-gray-200 dark:border-slate-700 p-6 hover:border-gray-300 dark:hover:border-slate-600 transition-colors"
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-4">
                    <div className="relative">
                      <div 
                        className="h-16 w-20 bg-gray-100 rounded-lg overflow-hidden border border-gray-200 shadow-sm cursor-pointer"
                        onClick={() => setPlayingVideo(video)}
                      >
                        <Image
                          src={getThumbnailPath(video)}
                          alt={`Thumbnail for ${video.original_filename}`}
                          width={80}
                          height={64}
                          className="w-full h-full object-cover transition-opacity duration-200"
                          onError={(e) => {
                            // Fallback to FilmIcon if image fails to load
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div className="flex items-center space-x-2">
                      <button
                        ...
                        className="p-2 text-gray-400 dark:text-slate-500 hover:text-gray-600 dark:hover:text-slate-300 rounded-lg hover:bg-gray-100 dark:hover:bg-slate-700"
                        title="View details"
                      >
                ...
                {/* Additional Info Row */}
                <div className="mt-4 pt-4 border-t border-gray-100 dark:border-slate-600 flex items-center justify-between text-xs text-gray-500 dark:text-slate-400">
                  <div className="flex items-center space-x-4">
                    <span>
          ...
          <div className="bg-white rounded-lg p-6 max-w-4xl w-full mx-4 max-h-[90vh] overflow-y-auto">
            ...
            <div className="relative bg-black rounded-lg overflow-hidden">
              <video
                ...
                src={getVideoPath(playingVideo)}
                onError={(e) => {
                  console.error('Video failed to load:', getVideoPath(playingVideo))
                  alert('Video could not be loaded. Please check if the video file exists.')
                }}
              >
            ...
            <div className="mt-4 grid grid-cols-2 gap-4 text-sm">
              <div>
                ...
                <span className="ml-2 font-medium">{Math.floor(playingVideo.duration / 60)}:{(playingVideo.duration % 60).toString().padStart(2, '0')}</span>
              </div>
              <div>
                <span className="text-gray-500">Resolution:</span>
                <span className="ml-2 font-medium">{playingVideo.width}x{playingVideo.height}</span>
              </div>
              <div>
                <span className="text-gray-500">Weather:</span>
                <span className="ml-2 font-medium capitalize">{playingVideo.weather || 'N/A'}</span>
              </div>
              <div>
                <span className="text-gray-500">Time:</span>
                <span className="ml-2 font-medium capitalize">{playingVideo.time_of_day || 'N/A'}</span>
              </div>
            </div>
          </div>
        </div>
