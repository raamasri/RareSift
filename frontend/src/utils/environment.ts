...
export function detectEnvironment(): DeploymentConfig {
  ...
  if (isVercel) {
    ...
    // Local development
    backendUrl = process.env.NEXT_PUBLIC_API_URL || 'http://localhost:8001'
  } else {
...
export function getVideoSourceUrl(videoId: number, config: DeploymentConfig): {
  ...
  const videoMap: { [key: number]: { filename: string; folder: string } } = {
    1: { filename: 'GH010001.m4v', folder: 'driving_camera_footage' },
    2: { filename: 'GH010002.m4v', folder: 'driving_camera_footage' },
    3: { filename: 'GH010003.m4v', folder: 'driving_camera_footage' },
    4: { filename: 'GH010004.m4v', folder: 'driving_camera_footage' },
    5: { filename: 'GH010005.m4v', folder: 'driving_camera_footage' },
    6: { filename: 'GH010006.m4v', folder: 'driving_camera_footage' },
    7: { filename: 'GH010007.m4v', folder: 'driving_camera_footage' },
    8: { filename: 'GH010010.m4v', folder: 'driving_camera_footage' },
    9: { filename: 'GH020010.m4v', folder: 'driving_camera_footage' },
    15: { filename: 'GH010031.m4v', folder: 'static_camera_footage' },
    16: { filename: 'GH010032.m4v', folder: 'static_camera_footage' },
    17: { filename: 'GH010033.m4v', folder: 'static_camera_footage' },
    18: { filename: 'GH010034.m4v', folder: 'static_camera_footage' },
    19: { filename: 'GH010035.m4v', folder: 'static_camera_footage' },
    20: { filename: 'GH010036.m4v', folder: 'static_camera_footage' },
    21: { filename: 'GH010037.m4v', folder: 'static_camera_footage' },
    22: { filename: 'GH010038.m4v', folder: 'static_camera_footage' },
    23: { filename: 'GH010039.m4v', folder: 'static_camera_footage' },
    24: { filename: 'GH010041.m4v', folder: 'static_camera_footage' },
    25: { filename: 'GH010042.m4v', folder: 'static_camera_footage' },
    26: { filename: 'GH010043.m4v', folder: 'static_camera_footage' },
    27: { filename: 'GH010045.m4v', folder: 'static_camera_footage' }
  }

  const video = videoMap[videoId] || { filename: `VIDEO_${videoId}.m4v`, folder: 'driving_camera_footage' }
